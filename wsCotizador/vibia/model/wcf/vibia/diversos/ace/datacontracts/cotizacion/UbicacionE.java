...
/**
 *  UbicacionE bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class UbicacionE implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localUbicacion == null) {
            ...
            localUbicacion.serialize(MY_QNAME, xmlWriter);
        }
    }
    ...
    public static class Factory {
         ...
         */
        public static UbicacionE parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            UbicacionE object = new UbicacionE();
