...
public class Clausula implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":Clausula", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "Clausula", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Clausula parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Clausula object = new Clausula();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"Clausula".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (Clausula) model.wcf.vibia.diversos.ace.services.cotizacion.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
