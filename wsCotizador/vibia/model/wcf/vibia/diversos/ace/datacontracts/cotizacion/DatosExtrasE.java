...
/**
 *  DatosExtrasE bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DatosExtrasE implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localDatosExtras == null) {
            ...
            writeStartElement(null, namespace, "DatosExtras", xmlWriter);
            ...
            localDatosExtras.serialize(MY_QNAME, xmlWriter);
        }
    }
    ...
    public static class Factory {
         ...
         */
        public static DatosExtrasE parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DatosExtrasE object = new DatosExtrasE();
