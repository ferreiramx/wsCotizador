...
/**
 *  DatosGeneralesE bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DatosGeneralesE implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localDatosGenerales == null) {
            ...
            writeStartElement(null, namespace, "DatosGenerales", xmlWriter);
            ...
            localDatosGenerales.serialize(MY_QNAME, xmlWriter);
        }
    }
    ...
    public static class Factory {
         ...
         */
        public static DatosGeneralesE parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DatosGeneralesE object = new DatosGeneralesE();
